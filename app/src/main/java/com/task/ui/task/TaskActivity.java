...
public class TaskActivity extends BaseActivity<ActivityTaskBinding> implements TaskView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null)
        {
            ...
            productCategoryBundle.putString(FragmentConstants.TOOLBAR_HEADING,FragmentConstants.CATEGORY);
            navigateToSection(AppSection.CATEGORY, false,productCategoryBundle);
        }
        else
        {
            /**
    ...
    public ArrayList<Cart> notifyData()
    {
        ArrayList<Cart> cartArrayList       =  cartHelper.getAllRowsFromFirstTable();
